...
colors:
  ...
  text-muted: "#5A6472"
  text-light: "#9A9A9A"
  accent-light: "rgba(0, 153, 255, 0.08)"
  accent-medium: "rgba(0, 153, 255, 0.15)"
  border: "rgba(0, 153, 255, 0.2)"
  card-bg: "rgba(0, 153, 255, 0.04)"
  positive: "#059669"
  negative: "#dc2626"
...
- **Fonts** — already set to **Montserrat** (display) / **Montserrat** (body); ignore any preset font name lingering in prose.
